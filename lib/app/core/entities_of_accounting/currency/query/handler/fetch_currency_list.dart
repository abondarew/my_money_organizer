...
class CurrencyQueryHandlerFetchList extends BaseQueryHandler<CurrencyQueryFetchList, List<UsesCurrencyReadModel>>{
  final CurrencyBaseRepository repository;

  CurrencyQueryHandlerFetchList ({@required this.repository});

  @override
  Future<List<UsesCurrencyReadModel>> execute(CurrencyQueryFetchList query) async {
